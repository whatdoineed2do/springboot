...
public class HelloControllerTest
{
    ...
    public void testRollDiceEven() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/roll/dice")).andExpect(status().isBadRequest());
    }
    ...
    public void testPostObject() throws Exception
    {
        ...
        mockMvc
                .perform(post("/api/v1/objects/1234")
    ...
    {
        mockMvc.perform(get("/api/v1/objects")).andExpect(status().isOk());
    }
    ...
    public void testGetObjectNotFound() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/objects/1234")).andExpect(status().isNotFound());
    }

    @Test
    public void testExceptionNotImplemented() throws Exception
    {
        mockMvc.perform(get("/api/v1/exception/notimplemented")).andExpect(status().isNotImplemented());
    }
    ...
    public void testPingThrowsExceptionOnThirdCall() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/ping")).andExpect(status().isInternalServerError());
    }
    ...
    public void testRollDiceOdd() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/roll/dice")).andExpect(status().isIAmATeapot());
    }
    ...
    public void testPostObjectNotImplemented() throws Exception
    {
        ...
        mockMvc
                .perform(post("/api/v1/objects/666")
                        .content("{ \"what\": \"test\" }")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void testGetObjectsInternalServerError() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/objects")).andExpect(status().isInternalServerError());
    }
    ...
    public void testGetObjectThrowsException() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/objects/1234")).andExpect(status().isInternalServerError());
    }
    ...
    public void testGetObject404WithFail404Param() throws Exception
    {
        ...
        mockMvc.perform(get("/api/v1/objects/1234?fail_404=yes")).andExpect(status().isInternalServerError());
    }
}
